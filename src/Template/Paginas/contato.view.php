<main id="contato">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="bg-secondary rounded-36 d-flex align-items-center justify-content-center cardd px-1 mt-1 mt-lg-0">
                            <img width="50px" src="<?= asset('images/icones/loc.png') ?>" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="bg-secondary rounded-36 d-flex align-items-center justify-content-center cardd px-1 mt-1 mt-lg-0">
                            <img width="50px" src="<?= asset('images/icones/email.png') ?>" alt="">
                        <div class="d-flex flex-column ms-2">
    ...
    <section class="form position-relative z-index-1">
        <div class="container position-relative">
            <div class="row px-1">
                <div class="col-lg-8 bg-white m-lg-auto d-flex flex-column align-items-center justify-content-center py-lg-4 px-lg-4 p-2 rounded-36 shadow">
                    ...
                    <form action="" class="w-100 px-0">
                        ...
                        <div class="d-flex mt-2 px-2 px-lg-0">
                            <p class="p-16 p-400 text-center w-100">
            ...
            <iframe class="position-absolute mapa" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3484.3792685426934!2d-51.19463441164262!3d-29.15349392705367!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x951ea2cff5f2e973%3A0xc4e4e9080a947950!2sSolus%20Incorporadora%20Ltda!5e0!3m2!1spt-BR!2sbr!4v1682346139196!5m2!1spt-BR!2sbr" 
                    width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <svg class="position-absolute riscos3" width="867" height="637" viewBox="0 0 867 637" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="mais-empreendimentos contato-border position-relative bg-secondary ">
        <div class="padding-top-border-section">
            <div class="border-section position-relative z-index-background"></div>
        </div>
    </section>
